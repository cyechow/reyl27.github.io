...
var debug = require('debug')('mmldata:server');
...
app.get('/', (req, res) =>{
  this.response.json({info: 'HTTP/XML Diff Tool API'})
})

app.get('/getDiff', db.getDiff)
/**
...
function onListening() {
  ...
  var bind = typeof addr === 'string'
    ? 'pipe ' + addr
    : 'port ' + addr.port;
  console.log('HTTP/XML Diff API listening on ' + bind);
}
